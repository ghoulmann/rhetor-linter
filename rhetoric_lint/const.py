...
RULE_DESCRIPTIONS = {
    ...
    "Attention.LongSentence":           "Sentence exceeds the maximum token count and should be split for readability.",
    ...
    # SP_MDLINT_FULL — native markdownlint rules
    "markdownlint.MD004":  "Unordered list style is inconsistent within the document.",
    "markdownlint.MD005":  "Inconsistent indentation for list items at the same level.",
    "markdownlint.MD007":  "Unordered list indentation does not match the configured value.",
    "markdownlint.MD011":  "Reversed link syntax: use [text](url) not (text)[url].",
    "markdownlint.MD014":  "Dollar sign before shell command without accompanying output.",
    "markdownlint.MD018":  "No space after hash on ATX heading.",
    "markdownlint.MD019":  "Multiple spaces after hash on ATX heading.",
    "markdownlint.MD020":  "No space inside closed ATX heading.",
    "markdownlint.MD021":  "Multiple spaces inside closed ATX heading.",
    "markdownlint.MD023":  "Headings must start at the beginning of the line.",
    "markdownlint.MD024":  "Multiple headings with the same content.",
    "markdownlint.MD026":  "Trailing punctuation in heading.",
    "markdownlint.MD027":  "Multiple spaces after blockquote symbol.",
    "markdownlint.MD028":  "Blank line inside blockquote.",
    "markdownlint.MD029":  "Ordered list item prefix does not match the configured style.",
    "markdownlint.MD030":  "Spaces after list markers do not match the configured value.",
    "markdownlint.MD033":  "Inline HTML element not in the allowed list.",
    "markdownlint.MD034":  "Bare URL found — wrap in angle brackets or use link syntax.",
    "markdownlint.MD035":  "Horizontal rule style is inconsistent.",
    "markdownlint.MD036":  "Emphasis used as a heading (entire line is emphasis).",
    "markdownlint.MD037":  "Spaces inside emphasis markers.",
    "markdownlint.MD038":  "Spaces inside code span.",
    "markdownlint.MD039":  "Spaces inside link text brackets.",
    "markdownlint.MD042":  "Empty link: link text or destination is missing.",
    "markdownlint.MD043":  "Heading structure does not match the required structure.",
    "markdownlint.MD044":  "Proper name has incorrect capitalization.",
    "markdownlint.MD046":  "Code block style should use fenced blocks.",
    "markdownlint.MD047":  "File should end with a single newline character.",
    "markdownlint.MD048":  "Fence marker style is inconsistent (backtick vs tilde).",
    "markdownlint.MD049":  "Emphasis style is inconsistent (asterisk vs underscore).",
    "markdownlint.MD050":  "Strong style is inconsistent (asterisk vs underscore).",
    "markdownlint.MD051":  "Link fragment does not match any heading anchor.",
    "markdownlint.MD052":  "Reference link label is not defined.",
    "markdownlint.MD053":  "Unused link or image reference definition.",
    "markdownlint.MD054":  "Link or image style not allowed by configuration.",
    "markdownlint.MD055":  "Table pipe style is inconsistent.",
    "markdownlint.MD056":  "Table row has a different column count than the delimiter row.",
    "markdownlint.MD058":  "Table is not surrounded by blank lines.",
    "markdownlint.MD059":  "Non-descriptive link text (e.g. 'here', 'click here').",
    "markdownlint.MD060":  "Trailing spaces inside fenced code block.",
}
...
RULE_SEVERITY_LEVELS = {
    ...
    "Attention.LongSentence": "warning",
    ...
    # SP_MDLINT_FULL — native markdownlint rules
    "markdownlint.MD004":  "suggestion",
    "markdownlint.MD005":  "suggestion",
    "markdownlint.MD007":  "suggestion",
    "markdownlint.MD011":  "warning",
    "markdownlint.MD014":  "suggestion",
    "markdownlint.MD018":  "suggestion",
    "markdownlint.MD019":  "suggestion",
    "markdownlint.MD020":  "suggestion",
    "markdownlint.MD021":  "suggestion",
    "markdownlint.MD023":  "suggestion",
    "markdownlint.MD024":  "warning",
    "markdownlint.MD026":  "suggestion",
    "markdownlint.MD027":  "suggestion",
    "markdownlint.MD028":  "suggestion",
    "markdownlint.MD029":  "suggestion",
    "markdownlint.MD030":  "suggestion",
    "markdownlint.MD033":  "warning",
    "markdownlint.MD034":  "warning",
    "markdownlint.MD035":  "suggestion",
    "markdownlint.MD036":  "suggestion",
    "markdownlint.MD037":  "suggestion",
    "markdownlint.MD038":  "suggestion",
    "markdownlint.MD039":  "suggestion",
    "markdownlint.MD042":  "warning",
    "markdownlint.MD043":  "warning",
    "markdownlint.MD044":  "suggestion",
    "markdownlint.MD046":  "suggestion",
    "markdownlint.MD047":  "warning",
    "markdownlint.MD048":  "suggestion",
    "markdownlint.MD049":  "suggestion",
    "markdownlint.MD050":  "suggestion",
    "markdownlint.MD051":  "warning",
    "markdownlint.MD052":  "warning",
    "markdownlint.MD053":  "suggestion",
    "markdownlint.MD054":  "suggestion",
    "markdownlint.MD055":  "warning",
    "markdownlint.MD056":  "warning",
    "markdownlint.MD058":  "suggestion",
    "markdownlint.MD059":  "warning",
    "markdownlint.MD060":  "suggestion",
}
