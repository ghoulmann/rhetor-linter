...
> **Note:** > Cassandra and Kubernetes both use the term _node_ to mean a member of a cluster. In this
...
> **Caution:** > [Minikube](https://minikube.sigs.k8s.io/docs/) defaults to 2048MB of memory and 2 CPU.
