...
<!-- overview -->
This tutorial shows you how to install  drivers in your cluster and how to
use them in conjunction with the DRA APIs to allocate  to Pods. This page is intended for cluster administrators.
...
DRA specific APIs in the `resource.k8s.io` API group including , , , as well as
...
likely deployed as a  to all or a
selection of the nodes (using  or similar mechanisms) in your cluster.
...
This section shows you how to use  to
...
of the request to a specific device class. The request itself can include a  expression that references attributes that
