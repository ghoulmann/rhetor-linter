...
[`kubectl get`](/docs/reference/generated/kubectl/kubectl-commands/#get) to  the creation
...
> **Note:** > To configure the integer ordinal assigned to each Pod in a StatefulSet, see
...
```
> **Note:** > You also need to delete the persistent storage media for the PersistentVolumes
