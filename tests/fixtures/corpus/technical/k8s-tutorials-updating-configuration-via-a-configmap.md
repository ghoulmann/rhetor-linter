...
> **Note:** > The total delay from the moment when the ConfigMap is updated to the moment when
...
> **Note:** > Immutable ConfigMaps are especially used for configuration that is constant and is **not** expected
...
> **Note:** > Once a ConfigMap is marked as immutable, it is not possible to revert this change
