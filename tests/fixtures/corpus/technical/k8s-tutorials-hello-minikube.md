...
> **Note:** > Only execute the instructions in __Step 1, Installation__. The rest is covered on this page.
...
> **Note:** > The `dashboard` command enables the dashboard add-on and opens the proxy in the default web browser.
...
> **Note:** > For more information about `kubectl` commands, see the [kubectl overview](/docs/reference/kubectl/).
